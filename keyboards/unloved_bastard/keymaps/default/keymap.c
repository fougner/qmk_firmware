...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[KM_QWERTY] = KEYMAP(\
                 ...
                 KC_LCTL,KC_LGUI,KC_LALT,                KC_SPC,                                 KC_RALT,KC_RGUI, KC_FN0,  KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT  ),
	...
	[KM_MEDIA] = KEYMAP( \
		...
		_______,_______,_______,                        _______,                        _______,_______,KC_FN0 ,_______,   _______,_______,_______)
};
